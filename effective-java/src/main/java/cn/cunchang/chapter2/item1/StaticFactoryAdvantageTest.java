...
public class StaticFactoryAdvantageTest {
    ...
    public void test_1_NameMeansMeaning() {
        ...
        System.out.printf("probablePrime:%s", bigInteger);
    }
    ...
    public void test_2_InstanceControlled() {
        ...
        System.out.printf("bool1==bool2? is ",bool1==bool2);
        Boolean bool3 = new Boolean(true);
        Boolean bool4 = new Boolean(true);

        System.out.printf("bool1==bool2? is ",bool3==bool4);
        // 2、不可变实例
...
//        GenderEnum.MALE.name = "女";
    ...
    public void test_4_DynamicReturnObject() {
        ...
        System.out.printf("regularEnumSet:%s", regularEnumSet.getClass());
        // JumboEnumSet
        EnumSet<BigEnum> jumboEnumSet = EnumSet.allOf(BigEnum.class);
        System.out.printf("jumboEnumSet:%s", jumboEnumSet.getClass());
    }
